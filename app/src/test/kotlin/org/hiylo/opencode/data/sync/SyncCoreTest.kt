...
import org.hiylo.opencode.data.repository.SyncBackend
import org.hiylo.opencode.data.repository.SyncConfig
import org.hiylo.opencode.data.repository.SyncTargetConfig
import org.hiylo.opencode.data.repository.migrateSingleBackendSyncConfig
import org.hiylo.opencode.data.repository.requireSingleSyncStorage
import org.hiylo.opencode.data.repository.remapServerScopedKey
...
class SyncCoreTest {
    ...
    fun legacySingleBackendBecomesPrimaryWithoutEnablingOtherStorage() {
        ...
        val webDav = migrateSingleBackendSyncConfig(
            ...
            endpoint = "https://dav.example/OpenCode.json",
            username = "user",
            autoSync = false,
    ...
    fun syncConfigurationRejectsTwoEnabledStorages() {
        val both = SyncConfig(
            ...
            webDav = SyncTargetConfig(enabled = true, endpoint = "https://dav.example/OpenCode.json"),
        )
