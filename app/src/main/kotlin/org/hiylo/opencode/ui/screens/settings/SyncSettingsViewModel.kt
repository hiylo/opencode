...
import org.hiylo.opencode.data.repository.SyncRepository
import org.hiylo.opencode.data.repository.SyncTargetConfig
import org.hiylo.opencode.data.sync.SyncWorkScheduler
...
class SyncSettingsViewModel @Inject constructor(
    ...
    val state = repository.state.stateIn(
        ...
        initialValue = org.hiylo.opencode.data.repository.SyncState(),
    )
