...
fun DiagnosticsScreen(
    ...
    suspend fun exportText(): String = buildString {
        ...
        appendLine("OpenCode diagnostics")
    ...
    fun shareAsFile() {
        scope.launch {
            ...
            val file = withContext(Dispatchers.IO) {
                ...
                File(directory, "opencode-diagnostics-${System.currentTimeMillis()}.txt").apply { writeText(text) }
            }
            ...
            context.startActivity(
                Intent.createChooser(
                    Intent(Intent.ACTION_SEND).apply {
                        ...
                        clipData = ClipData.newRawUri("OpenCode diagnostics", uri)
